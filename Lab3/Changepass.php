...
<body>
    ...
    <fieldset >
      ...
      <td><input type="text" name="currpass"><span class="red"></span>
      </td></tr>
      <tr>
      <td><label><span class="green">New Password:</span> </label></td>
      <td><input type="text" name="newpass"><span class="red"><?php echo $currErr ?></span></td></tr>
      <tr>
      <td><label><span class="red">Retype New Password: </span></label></td>
      <td><input type="text" name="retypepass"><span class="red"><?php echo $retypeErr ?></span></td></tr>
      </table>
      <br>
        <hr>
      <input type="submit">
